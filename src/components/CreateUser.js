...
function CreateUser() {
    ...
    const Push = (e) => {
        e.preventDefault();
        db.collection("students-list").add({
            name: name,
            email: email,
            mobile: mobile,
            Amount: Amount
            ...
            <div className="container">
                ...
                <Form onSubmit={Push}>
                    <Form.Group className="mb-4" controlId="formBasicMobile">
                        ...
                        <Form.Control type="username" placeholder="Enter username" value={name}
                            onChange={(e) => setName(e.target.value)} />
                    </Form.Group>
                    <Form.Group className="mb-4" controlId="formBasicMobile">
                        <Form.Label></Form.Label>
                        <Form.Label style={Styles.inh}>Mobile Number</Form.Label>
                        <Form.Control type="mobile" placeholder="Enter Mobile" value={mobile}
                    ...
                    <Form.Group className="mb-4" controlId="formBasicEmail">
                        ...
                        <Form.Control type="money" placeholder="Enter Money" value={Amount}
                            onChange={(e) => setAmount(e.target.value)} />
                    </Form.Group>

                    <button type="submit" style={Styles.btun}
                        disabled={
                            email.length === 0 ||
                            name.length === 0 ||
                            mobile.length < 10
